...
public interface ResultMapper {
    ...
    List<Results> selectResultByStuId(String stuId);

    @Select("select * from result")
    List<Results> selectAllResult();

    @Select("select * from result where stu_id = #{stuId} And res_term = #{resTerm}")
    List<Results> selectResultByStuIdAndTerm(@Param("stuId") String stuId, @Param("resTerm") String resTerm);

    @Insert("insert into result (stu_id, sub_name, res_num,res_term)values(#{stuId}, #{subName}," +
            "#{resNum}, #{resTerm})")
    int insertResult(Results results);
    ...
    Results selectResultByStuIdAndSubName(@Param("stuId") String stuId, @Param("subName") String subName );
    ...
    @Update("update result set stu_id = #{stuId}, sub_name = #{subName} where res_id = #{resId}")
    int updateStuIdAndSubNameByResId(@Param("stuId") String stuId, @Param("subName") String subName,
